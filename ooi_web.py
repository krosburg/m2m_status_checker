...
def writeENGSummary(fname):
    ...
    url_base = 'plotDisplay.php?org=3&size=300&param=Currents&labels=no&window='
...
def writePlotSuperSummary(fname):
    # If file doesn't exist, create it and write header
    if isfile(fname):
        f = open(fname, 'a')
    else:
    ...
    f.write('\t<br><br>\n')
    f.write('\t<li>\n')
    f.write('\t\t<a href="%sday" target="content">Super Summary</a>\n' % (url_base))
